...
export const mic_generatePdf = (data: [string, { result: string; remark: string }][], profileData: ProfileData) => {
  ...
  doc.setLineWidth(1);
  doc.line(10, y + imgHeight + 10, doc.internal.pageSize.width - 10, y + imgHeight + 10); // Adjusted line width to span the full page width
  ...
  doc.line(10, profileStartY + 20, doc.internal.pageSize.width - 10, profileStartY + 20); // Adjusted line width to span the full page width
